...
final class InternalSquareMap extends SquareMapper {
    ...
    private final int[] RANK_TO_INDEX = {
            0, 1, 2, 3, 4, 5, 6, 7
    };

    // Big-Endian Files (file A...H -> fileIndex 7...0)
    private final int[] FILE_TO_INDEX = {
            7, 6, 5, 4, 3, 2, 1, 0
    };
    ...
    private static final SquareMapper INSTANCE = new InternalSquareMap();

    private InternalSquareMap() {}
